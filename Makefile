...
# List all .cpp source files that make up the project.
# As new files are added in later phases, they must be added here.
OBJS = src/main.cpp \
       src/core/application.cpp \
       src/core/input_handler.cpp \
       src/core/audio_handler.cpp \
       ...
       src/game/piece_factory.cpp \
       src/game/score_tracker.cpp
